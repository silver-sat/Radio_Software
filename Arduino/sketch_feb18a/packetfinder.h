...
#ifndef CMDBUFFSIZE
#define CMDBUFFSIZE 1024  //4 packets at max packet size...but probably a lot more because commands are short
#endif
...
//CircularBuffer<byte, CMDBUFFSIZE>, mycmdbuffer;
//CircularBuffer<byte, DATABUFFSIZE>, mydatabuffer;
