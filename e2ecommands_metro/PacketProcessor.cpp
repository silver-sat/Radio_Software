/*
  CommandProcessor.cpp - Library for parsing command packets
...
PacketProcessor::PacketProcessor(CircularBuffer<byte, CMDBUFFSIZE> &cmdbuffer)
{
...
template <size_t S>
int PacketProcessor::find_packet(CircularBuffer<unsigned char, S> &mybuffer)
{
...
void PacketProcessor::get_command(CircularBuffer<byte, CMDBUFFSIZE> &cmdbuffer, int packetlength)
{

}

void PacketProcessor::get_body(CircularBuffer<byte, CMDBUFFSIZE> &cmdbuffer, int packetlength)
{

}

void PacketProcessor::get_crc(CircularBuffer<byte, CMDBUFFSIZE> &cmdbuffer, int packetlength)
{

}

void PacketProcessor::sendACK(byte code)
{

}

void PacketProcessor::sendNACK(byte code)
{
