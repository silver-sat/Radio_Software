 ...
 * @file fec.cpp
 * @author Libre Space
 * @brief FEC library for libre space AX5043 driver
 *
...
0x00,0xF9,0x3B,0x42,0x04,0x2B,0x7E,0xFB,
0x61,0x1E,0x03,0xD5,0x32,0x42,0xAA,0x05,
0x18,0x05,0xAA,0x42,0x32,0xD5,0x03,0x1E,
0x61,0xFB,0x7E,0x2B,0x04,0x42,0x3B,0xF9,0x00,
};
 ...
 * considered
 */
void rs_encode(uint8_t *parity, const uint8_t *data, size_t len)
{
...
int rs_decode(uint8_t *data, size_t len)
{
    ...
    {
        return -1; // this fixes an error in the libre space code.  It was returning 0 which it would also return if it didn't need to correct!
    }
 ...
 */
void conv_encoder_1_2_7(uint8_t *out, const uint8_t *data, size_t len)
{
 ...
 * @param len the number of input bytes in the \a data buffer
 */
void conv_encoder_2_3_7(uint8_t *out, const uint8_t *data, size_t len)
{
 ...
 * @param len the number of input bytes in the \a data buffer
 */
void conv_encoder_3_4_7(uint8_t *out, const uint8_t *data, size_t len)
{
 ...
 * @param len the number of input bytes in the \a data buffer
 */
void conv_encoder_5_6_7(uint8_t *out, const uint8_t *data, size_t len)
{
 ...
 * @param len the number of input bytes in the \a data buffer
 */
void conv_encoder_7_8_7(uint8_t *out, const uint8_t *data, size_t len)
{
