...
*/
#define Release_B   GPIO14_A
#define Release_A   GPIO13
#define Current_5V  GPIO12
#define TX_RX       GPIO11
#define RX_TX       GPIO10
#define PAENABLE    GPIO9
#define EN0         GPIO8
#define EN1         GPIO7
...
// On-board SPI     Flash Radio doesn't have a SPI flash
...
//#define SERIAL_PORT_USBVIRTUAL      SerialUSB  //changed to try to get serial usb to work
